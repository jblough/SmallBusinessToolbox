...
public class LicenseAndPermitDataAdapter extends ArrayAdapter<LicenseAndPermitData> implements Filterable {
	...
	holder.bookmarkedImage.setImageResource((app.bookmarks.isBookmarked(data)) ? 
